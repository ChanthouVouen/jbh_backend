...
<div class="font-[sans-serif] max-sm:px-4">
      <div class="min-h-screen flex flex-col items-center justify-center bg-gray-100">
        <div class="grid md:grid-cols-2 items-center gap-4 max-md:gap-8 max-w-6xl bg-white max-md:max-w-lg w-full p-4 m-4 shadow-[0_2px_10px_-3px_rgba(6,81,237,0.3)] rounded-md">
            ...
            <form>
              ...
              <div class="mt-12">
                ...
                <div class="relative flex items-center">
                  ...
                  <svg xmlns="http://www.w3.org/2000/svg" fill="#bbb" stroke="#bbb" class="w-[18px] h-[18px]" viewBox="0 0 682.667 682.667">
                    <defs>
